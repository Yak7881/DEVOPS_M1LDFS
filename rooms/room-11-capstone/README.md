...
| Room | Compétences utilisées |
|------|------------------------|
| 01 — Version Control | Git, commits, branches |
| 02 — Collaboration | Branches, merge |
| 03 — Team Workflow | Workflow de travail |
| 04 — GitHub GUI | Interface GitHub |
| 05 — Pipelines | CI/CD |
| 06 — Testing | Tests (si applicable) |
| 07 — Release | Tags, releases, changelog |
| 08 — Monitoring | (optionnel) |
| 09 — Jenkins | (optionnel) |
| 10 — Incident Response | (optionnel) |
