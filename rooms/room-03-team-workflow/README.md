...
|-------|-------------------|
| **Issue** | Un ticket dans GitHub. On l'utilise pour signaler un bug, proposer une idée ou poser une question. |
| **Branch naming** | Convention pour nommer les branches : `fix/...`, `feature/...`, `chore/...` |
| **Commit message** | Message court qui décrit le changement. Ex : "fix: corriger l'affichage du titre" |
| **PR checklist** | Liste de vérifications avant d'ouvrir une PR (tests, description, etc.) |
| **Code review** | Quelqu'un relit ton code. Il peut **approuver** ou **demander des changements**. |
...
- Exemples : [examples/team/](../../examples/team/)
